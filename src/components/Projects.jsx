...
export const Projects = () => {
  ...
  const projects = [
    ...
    {
      id: "02",
      title: "Shawrapinn Restaurant Platform",
    ...
    {
      id: "03",
      title: "ClawPaw AI Pet Diet Planner",
      subtitle: "INTELLIGENT NUTRITION & SCHEDULE ENGINE",
      desc: "AI-powered pet nutrition system that generates custom meal recommendations, caloric target calculations, and portion schedules based on pet medical data.",
      link: "https://clawpaw.vercel.app",
      github: "https://github.com/rkece",
      status: "LIVE DEPLOYMENT",
      tags: ["Next.js", "MongoDB", "AI Engine", "Tailwind CSS"],
      gradient: "from-[#0A0A0A] to-black",
    ...
    {
      id: "04",
      title: "Honsymp Academic Event Platform",
    ...
    {
      id: "05",
      title: "MonitorHub Anti-Drug Protocol",
    ...
    {
      id: "06",
      title: "Debugenix AI Code Debugger",
      subtitle: "AI ERROR TRACE & CORRECTION ENGINE",
      desc: "Intelligent code debugging application that analyzes runtime stack traces, isolates memory bugs, and suggests optimized refactoring patterns.",
      link: "https://github.com/rkece",
      github: "https://github.com/rkece",
      status: "UNDER CONSTRUCTION",
      tags: ["Python", "OpenAI API", "React.js", "TypeScript"],
      gradient: "from-[#0A0A0A] to-black",
    ...
    {
      id: "07",
      title: "Women Safety Guardian IoT",
      ...
      github: "https://github.com/rkece",
      status: "UNDER CONSTRUCTION",
      tags: ["Arduino", "GSM/GPS", "C++", "Emergency IoT"],
      gradient: "from-[#0A0A0A] to-black",
